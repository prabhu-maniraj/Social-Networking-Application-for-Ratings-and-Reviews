...
/**
 * Servlet implementation class displaydeletecategory
 */
@WebServlet("/displaydeletecategory")
public class displaydeletecategory extends HttpServlet {
...
//			String secondParam=request.getParameter("password");
			...
			if(request.getParameter("deletecategory").equals("DeleteCategory"))
			{
			...
			request.getRequestDispatcher("/View/createDelete.jsp").forward(request, response);
