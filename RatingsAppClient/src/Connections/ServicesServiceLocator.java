...
public class ServicesServiceLocator extends org.apache.axis.client.Service implements Connections.ServicesService {
    ...
    private java.lang.String Services_address = "http://localhost:8080/YelpFinal/services/Services";
    ...
    public Connections.Services getServices(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Connections.ServicesSoapBindingStub _stub = new Connections.ServicesSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Connections.Services.class.isAssignableFrom(serviceEndpointInterface)) {
                Connections.ServicesSoapBindingStub _stub = new Connections.ServicesSoapBindingStub(new java.net.URL(Services_address), this);
                _stub.setPortName(getServicesWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://Connections", "ServicesService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://Connections", "Services"));
        }
